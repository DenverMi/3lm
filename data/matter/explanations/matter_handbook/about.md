...
- **Informative companion**: Explains concepts, typical approaches, and decision points. No normative requirements live here.
- **Wayfinding layer**: Each page points to the appropriate official sources where requirements and formal processes are defined.
- **Practical guidance**: Focuses on explanations, patterns, and pointers you can apply in your workflow. Content may include tips or illustrative examples where useful, but it is not prescriptive.
...
directly, consider joining the Connectivity Standards Alliance.

- Media: For official updates, see the Alliance Newsroom or contact press@csa-iot.org.
...
We welcome fixes and additions. Open an issue or submit a PR in the Handbook GitHub repository.
