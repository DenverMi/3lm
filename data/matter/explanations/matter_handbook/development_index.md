...
To learn more, go to the Matter JavaScript SDK GitHub page.

Note: Some features of the Matter protocol are not yet implemented in the JavaScript SDK. For details about this check the matter.js Compatibility Information.

matter.js is an open source project of the Open Home Foundation and many community contributors.
